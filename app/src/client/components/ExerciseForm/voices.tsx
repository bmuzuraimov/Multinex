...
const voices: Voice[] = [
  ...
  {
    voice_id: "MyL7lTBMTsh6bANFa8WM",
    name: "Andrew - tech wizard",
    labels: {
      accent: "american",
      description: "casual",
      age: "young",
    ...
    preview_url: "https://storage.googleapis.com/eleven-public-prod/XnWQKpONeagjUl8iUXy6rvndEts2/voices/DnZ3SC5D2Rffh3AYJ6JI/f951da3b-66de-4b68-b7b0-e7b4db354fcd.mp3"
  }
];
