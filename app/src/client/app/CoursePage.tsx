    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-12">
          {topics?.map((topic) => <TaskSection key={topic.id} topic={topic} />)}
        </div>
      </div>
    </div>
  );
...
const TaskSection: React.FC<ExerciseSectionProps> = ({ topic }) => {
  ...
  return (
    <div className="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 rounded-3xl shadow-xl p-10 transition-all duration-300 hover:shadow-2xl border border-gray-200/50 dark:border-gray-700/50">
