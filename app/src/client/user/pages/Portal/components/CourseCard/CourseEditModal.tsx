  ...
  return (
    <Dialog open={is_open} onOpenChange={onClose}>
      <DialogContent className='sm:max-w-[625px]'>
        <DialogHeader>
          <DialogTitle className='text-2xl font-semibold text-primary-900 font-montserrat'>Edit Course</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          <div className='space-y-4'>
            ...
            <div>
              <Label className='text-sm font-montserrat text-primary-800 mb-2'>Course Image</Label>
          ...
          <DialogFooter className='gap-3'>
            <Button type='button' variant='outline' onClick={onClose} className='text-primary-700'>
              Cancel
            </Button>
