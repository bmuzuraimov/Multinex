...
import { Loader2, Settings, FileQuestion, Ear, Keyboard, Pencil, Sparkles } from 'lucide-react';
      ...
      <Dialog open={true} onOpenChange={() => on_discard()}>
        <DialogContent className='sm:max-w-2xl'>
          ...
          <Card>
            <CardContent className='p-6 space-y-6'>
              ...
              <div className='space-y-3'>
                <Label className='font-montserrat text-sm text-gray-700'>Topics</Label>
          ...
          <DialogFooter className='mt-6'>
            <Button variant='outline' onClick={on_discard} className='font-satoshi'>
              Cancel
            </Button>
            <Button
