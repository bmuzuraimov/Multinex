    ...
    <div className='max-w-7xl mx-auto px-4 py-12 text-manrope dark:bg-gray-900'>
        ...
        {user?.email === ADMIN_EMAIL && (
          <div className='mb-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm'>
            ...
            <div className='space-y-4'>
              ...
              <button onClick={handleAddFeature} className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600'>
                Add Feature
              </button>
            </div>
          </div>
      ...
      <section className='text-center'>
        <p className='text-gray-600 dark:text-gray-400'>
          ...
          <a href={`mailto:${ADMIN_EMAIL}`} className='text-blue-500 hover:underline flex items-center justify-center'>
