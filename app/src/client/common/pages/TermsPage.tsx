      ...
      <div className='max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8'>
        ...
        <Card className='border-none shadow-lg bg-gradient-to-br from-primary-50 to-secondary-50 mb-8'>
          <CardHeader className='space-y-4'>
            ...
            <CardTitle className='text-4xl font-satoshi font-bold text-primary-900'>Terms of Service</CardTitle>
        ...
        <Accordion type='single' collapsible className='w-full space-y-4'>
          ...
          <AccordionItem value='item-4' className='border rounded-lg shadow-sm bg-white'>
            ...
            <AccordionContent className='px-6 py-4 text-primary-700'>
              All content and services provided on this platform, including but not limited to text, graphics, logos,
              and software, are the property of Multinex.app or our licensors and are protected by copyright and
              intellectual property laws. You may not use, reproduce, or distribute any content from our platform
          ...
          <AccordionItem value='item-5' className='border rounded-lg shadow-sm bg-white'>
            ...
            <AccordionContent className='px-6 py-4 text-primary-700'>
              ...
              processing. By using our service, you agree to the terms and policies of these third-party providers. We
              are not liable for any issues arising from their use.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value='item-7' className='border rounded-lg shadow-sm bg-white'>
            ...
            <AccordionContent className='px-6 py-4 text-primary-700'>
              ...
              reason, including violation of these terms or any behavior that we consider harmful to the platform or
              other users.
            </AccordionContent>
          </AccordionItem>
        ...
        <Card className='mt-8 border-none shadow-lg bg-gradient-to-br from-secondary-50 to-primary-50'>
          <CardContent className='p-6'>
            <div className='flex items-center justify-center space-x-2 text-primary-700'>
              ...
              <p className='text-sm'>These terms are subject to change. Last updated: January 2024</p>
            </div>
          </CardContent>
        </Card>
      </div>
...
export default DefaultLayout(TermsPage);
