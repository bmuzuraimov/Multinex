  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-6 text-lg text-gray-700">
        <section>
          <h2 className="text-2xl font-semibold text-gray-800">1. Data Collection</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800">2. Data Processing</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800">3. Third-Party Services</h2>
          <p>
            We utilize a few trusted third-party services to ensure the best user experience:
          </p>
          <ul className="list-disc pl-5">
            <li>
              <strong>Plausible Analytics:</strong> This service helps us understand overall 
              user behavior on the site without collecting personal data. It anonymizes 
              user interactions, ensuring your privacy.
            </li>
            <li>
              <strong>Stripe:</strong> For secure payment processing, we use Stripe, a 
