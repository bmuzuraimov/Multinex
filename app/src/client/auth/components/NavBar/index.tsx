...
import { PUBLIC_NAVBAR } from '../../../../shared/constants';
...
const NavigationLink = ({
  ...
  return (
    <Link
      to={item.href as any}
      onClick={onClick}
      className={cn(base_classes, is_mobile ? mobile_classes : desktop_classes)}
    >
      {item.name}
    </Link>
  );
...
const NavBar = () => {
  ...
  const public_paths = [
    routes.LandingRoute.build(),
    routes.LoginRoute.build(),
    routes.SignupRoute.build(),
    routes.AboutRoute.build(),
    routes.PublicCoursesRoute.build(),
    routes.PrivacyRoute.build(),
    routes.TermsRoute.build(),
